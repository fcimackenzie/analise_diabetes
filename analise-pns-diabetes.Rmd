...
pns_design_srvyr <- pns_design_srvyr %>% 
     mutate(fx_esc = case_when(d009 == "  " ~ "0",
                               d009 == "01" | d009 == "02" | d009 == "03" | d009 == "05" |  d009 == "06"  ~ "1",
                               d009 == "04" | d009 == "07" | d009 == "08" | d009 == "09" ~ "2",
                               d009 == "10" ~ "3",
                               d009 == "11" ~ "4",
                               d009 == "12" ~ "5"
                                 ))
...
df$variables$pressao_alta_q002.. = NULL
df$variables$colesterol_alto_q060.. = NULL
df$variables$diagnostico_diabetes_q030.. = NULL
df$variables$diagnostico_diabetes_q030.2 = NULL
df$variables$diagnostico_diabetes_q030.3 = NULL
```
...
fla <- paste("diagnostico_diabetes_q030.1 ~", paste(names(df$variables[1:101]), collapse="+"))

gl1 <- survey::svyglm(as.formula(fla) , family = binomial, design=df)
